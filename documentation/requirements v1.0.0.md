### requirements for kacky world records statistics bot version 1.0

URF-001 - Must - Not Done - The system must be able to request the map leaderboard for any kacky reloaded map
URF-002 - Must - Not Done - The system must be able to request player data
...
### Overall world records statistics
-Percentage/total helm world records
-Oldest world record
-Newest world record